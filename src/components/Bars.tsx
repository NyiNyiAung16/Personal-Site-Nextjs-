export default function Bars({ className, onClick }: { className?: string, onClick?: () => void }) {
  return (
    <svg viewBox="0 0 448 512" className={`cursor-pointer ${className}`} xmlns="http://www.w3.org/2000/svg" onClick={onClick}>
